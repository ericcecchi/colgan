...
function wp_pagenavi($more, $before = '', $after = '') {
			...
			switch(intval($pagenavi_options['style'])) {
				case 1:
					...
					for($i = $start_page; $i  <= $end_page; $i++) {						
						...
						if($i == ($paged-1)) {
							if (!$more){
								echo '<p class="button alignleft"><a href="'.clean_url(get_pagenum_link($i)).'"><span>Older Entries</span></a></p>';
							} else {
								echo '<p class="button alignleft"><a href="'.clean_url(get_pagenum_link($i)).'"><span>Previous</span></a></p>';							
							}
						}

						if($i == ($paged+1)) {
							if (!$more) {
								echo '<p class="button alignright"><a href="'.clean_url(get_pagenum_link($i)).'"><span>Newer Entries</span></a></p>';
							} else {
								echo '<p class="button alignright"><a href="'.clean_url(get_pagenum_link($i)).'"><span>Next</span></a></p>';							
							}
						}
					}
